...
@section('content')
    <div class="container mx-auto bg-white p-5 rounded-md shadow-sm">
        ...
        <hr class="mb-4">
        <a href="{{ route('units.create') }}" class="px-4 py-2 bg-green-400 rounded-md text-white">
              ...
              <tbody class="text-gray-700">
                @foreach ($units as $unit)
                    <tr>
                        ...
                        <td class="py-3 px-4">
                            <a href="{{ route('units.edit', $unit->id) }}" class="bg-blue-500 text-white px-4 py-2 rounded">
